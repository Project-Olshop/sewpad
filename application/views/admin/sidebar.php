            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                                    <a class="nav-link" href="<?php echo base_url();?>KategoriTutorial">
                                        ...
                                        <span class="nav-link-text">Kategori Tutorial</span>
                                    </a>
                                </li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Laporan <span class="label label-rouded label-success pull-right">2</span></span></a>
                            <ul aria-expanded="false" class="collapse">
